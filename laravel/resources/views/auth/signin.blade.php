...
<head>
    ...
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
    <title>Sign In | Wartechlog</title>
        ...
        <nav class="navbar bg-white navbar-area-1 navbar-area navbar-expand-lg">
            <div class="container nav-container">
                ...
                <div class="nav-right-part nav-right-part-mobile">
                    <a class="signin-btn" href="{{ route('dashboard') }}">Sign In</a>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-7">
                    ...
                    @endif
                    <form action="{{ route('auth.process') }}" method="POST" class="signin-inner">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                <a href="{{ route('auth.signup') }}"><strong>Sign Up</strong></a>
                            </div>
                        </div>
                    </form>
                </div>
